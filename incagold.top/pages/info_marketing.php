...
<div style="color: #ffffff; text-align: left; margin-top: 20px;">
    
  <center>    <b>
    1. Автоматическая покупка
    <br>
    Все уровни, за исключением первого, покупаются автометически.
    <br><br>
    2 Не нужно ждать
    <br>
    Зачисления поступают мгновенно за каждого зашедшего на уровень.
    <br><br>
    3. 100% в сеть
    <br>
    Все денежные переводы 100% распределяются между пользователями.
    <br><br>
    4. 100 % гарантии
    <br>
    Гарантия что вы вернёте свой вклад с первого партнёра. Система поставит вам автоматически.
    <br><br>
    5. Автоматизация бизнеса
    <br>
    Автоматизация бизнеса и создание пассивного дохода!
    <br><br>
    6. Получения дохода.
    <br>
    Возможность получать доход, даже если вы ни кого не пригласили!
    <br><br><br><br>
</div></div></div>
  </div>  </div>
</div></div>

 ...
 <div class="wrapper">
  ...
  <div class="headerInner fadeInLeft wow"><a href="/"><img style="width: 220px;height: 40px;" src="/styles/images/logo.gif"></img></a>
       ...
       <li class="nav-item active">
        ...
        <!-- //header -->   
        <!-- //header -->    
<h1><span class="fa fa-book"></span> Тех поддержка </h1>
<div style="color: #ffffff; text-align: left; margin-top: 20px;">

    <br><br>
<center><b>

    Сперва ознакомтесь с <a href="/faq">Частые вопросы</a> и если не найдете в них ответа,
<br>
<br>
    напишите в тех. поддержку: inca.gold@yandex.ru
    <br>
    <br>
    <br>
    Время ответа в течении 24-х часов.
